...
class ManoGaussianModel(GaussianModel):
    ...
    def training_setup(self, training_args):
        ...
        # self.mano_param['root_pose'].requires_grad = True
        self.mano_param['hand_pose'].requires_grad = True
        params = [
            # self.mano_param['root_pose'],
        ...
        # param_trans = {'params': [self.mano_param['root_trans']], 'lr': training_args.flame_trans_lr, "name": "trans"}
